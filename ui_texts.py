...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "ziwei_pdf_caption": "PDF 含命盘摘要、本地解读；若已生成 AI 深批将一并收录。",
    ...
    "en": {
        ...
        "ziwei_intro": "Reuses your BaZi birth data. Local chart + reading are free for everyone. AI deep read is available to all; Gold/Diamond get a clean view and PDF download.",
        ...
        "ziwei_run": "Cast chart & local reading",
        "ziwei_chart_heading": "Zi Wei chart",
        "ziwei_local_heading": "Local reading",
        ...
        "ziwei_pdf_caption": "PDF includes chart summary and local reading; AI chapters are included when generated.",
