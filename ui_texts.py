...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "forgot_password_hint": "本 App 使用独立密码、暂未开通自动邮件重置。请填写注册邮箱提交申请，管理员会为您重置并告知新密码。",
        "forgot_password_email": "注册邮箱",
        "forgot_password_submit": "提交重置申请",
        "forgot_password_ok": "已收到申请。请等待管理员重置后告知新密码（可再次登录）。",
        "forgot_password_fail": "提交失败，请稍后重试或直接联系客服。",
        ...
        "admin_reset_password_hint": "为本 App 设置新密码（至少 6 位）。生成后请复制发给用户；页面刷新后不再显示明文。",
        "admin_new_password": "新密码",
        "admin_gen_password": "随机生成",
        "admin_save_password": "保存新密码",
        "admin_password_saved": "密码已更新。请立即复制下方密码发给用户：",
        "admin_password_too_short": "密码至少 6 位。",
        "admin_password_need": "请先填写或生成新密码。",
        "admin_reset_requested": "该用户曾申请重置密码",
        "delete_user": "删除用户",
        "refresh_data": "刷新数据",
        "bulk_ops": "批量操作",
    ...
    "en": {
        ...
        "forgot_password_hint": "This app uses its own password and has no auto email reset yet. Enter your registered email to request a reset; an admin will set a new password for you.",
        "forgot_password_email": "Registered email",
        "forgot_password_submit": "Request password reset",
        "forgot_password_ok": "Request received. Wait for an admin to reset your password, then sign in again.",
        "forgot_password_fail": "Could not submit. Try again later or contact support.",
        ...
        "admin_reset_password_hint": "Set a new BaZi-app password (min 6 chars). Copy it to the user now; it won’t be shown again after refresh.",
        "admin_new_password": "New password",
        "admin_gen_password": "Generate",
        "admin_save_password": "Save new password",
        "admin_password_saved": "Password updated. Copy and send to the user now:",
        "admin_password_too_short": "Password must be at least 6 characters.",
        "admin_password_need": "Enter or generate a new password first.",
        "admin_reset_requested": "This user requested a password reset",
