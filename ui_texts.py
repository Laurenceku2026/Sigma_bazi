...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tab_survey": "📝 试用反馈",
        "ziwei_heading": "🌌 紫微斗数",
        "ziwei_intro": "沿用八字生辰资料：四化/三合/飞星排盘 + 基础解读全员开放；AI 深批全员可生成，金卡/钻石无水印并可下载 PDF。",
        "ziwei_theory_title": "📖 紫微斗数基本理论",
        "ziwei_need_chart": "请先在「输入信息」完成排盘，以便沿用同一套生辰；本页会用其公历/时辰与年柱时支排紫微。",
        "ziwei_run": "排盘并生成基础解读",
        "ziwei_chart_heading": "紫微命盘",
        "ziwei_local_heading": "基础解读",
        "ziwei_mode_label": "排盘视角",
        "ziwei_mode_sihua": "四化",
        "ziwei_mode_sanhe": "三合",
        "ziwei_mode_feixing": "飞星",
        "ziwei_mode_hint": "读盘顺序：三合→四化→飞星。三合=命宫三方四正格局；四化=生年禄权科忌落点；飞星=各宫天干飞化路径（如禄→财帛）。左下「大限 x～y岁 / 年份」是该宫十年运。详情见上方「基本理论」。",
        "ziwei_basic_hint": "读盘顺序：三合→四化→飞星→大限，再事业/财运/感情/健康（规则摘要，非 AI）。",
        "ziwei_ai_btn": "生成 AI 深批",
        "ziwei_ai_btn_reuse": "查看已有 AI 深批",
        "ziwei_ai_btn_regen": "重新生成 AI 深批",
        "ziwei_ai_reuse_unchanged": "出生资料未变，已直接打开上次紫微 AI 深批（未调用 DeepSeek、未扣次数）。",
        "ziwei_ai_heading": "AI 深批（事业·财运·感情·健康）",
        "ziwei_ai_career": "事业",
        "ziwei_ai_wealth": "财运",
        "ziwei_ai_love": "感情",
        "ziwei_ai_health": "健康",
        "ziwei_ai_fail": "AI 深批失败：",
        "ziwei_ai_need_login": "请先登录后再生成 AI 深批。",
        "ziwei_ai_watermark_note": "当前为水印预览。升级金卡后可无水印浏览，并下载含 AI 深批的 PDF。",
        "ziwei_ai_clean_note": "金卡/钻石：AI 深批无水印，可下载 PDF 报告。",
        "ziwei_pdf_caption": "专业 PDF（文字可选中）：封面目录 → 三合/四化/飞星盘图 → 完整基础解读 → AI 深批。",
        "ziwei_download_pdf": "下载紫微 PDF 报告",
        "ziwei_reuse_caption": "生辰来源：当前八字排盘资料",
        "name_heading": "✍️ 姓名详批",
        "name_intro": "姓名报告：本地康熙/繁体笔画五格 + 用字五行提示 + 与八字喜用对照。输入姓名即可查看，无需按钮、不调用 AI。简繁皆可（内部转繁计画）。补的是喜用，不是简单缺啥补啥。",
        "name_need_chart": "建议先在「输入信息」完成排盘，以便对照八字喜用；也可先看五格结果。",
        "name_input": "姓名",
        "name_input_ph": "如：张伟 / 張偉 / 欧阳修",
        "name_input_hint": "默认沿用八字输入的姓名；修改后下方结果会即时更新。",
        "name_enter_hint": "请输入姓名（至少姓+名两字），下方将自动显示详批。",
        "name_compound": "复姓（两字姓）",
        "name_analyze": "生成姓名报告",
        "name_summary": "摘要",
        "name_full": "完整报告",
        "name_free_banner": "全员开放：完整姓名详批，无水印。",
        "name_upgrade_hint": "姓名详批已对全员开放。",
        "name_stroke_note": "计画规则：以康熙字典/姓名学繁体笔画为准；简体仅便于输入。",
        "name_kangxi_convert": "计画转换：输入「{src}」→ 康熙/繁体「{trad}」",
        "name_variant_note": "异体提示：{detail}",
        "name_theory_title": "📖 姓名理论",
        "hehun_heading": "💕 八字合婚",
        ...
        "ai_deep_btn_reuse": "✨ 查看已有 AI 深批",
        "ai_deep_btn_free": "✨ AI 深批预览（扣免费次数）",
        "ai_deep_reuse_unchanged": "出生资料未变，已直接打开上次 AI 深批（未调用 DeepSeek、未扣次数）。",
        ...
        "admin_sql_hint": "请确认：1) 已执行 sql/001～010（含 010 修复 reports→sf_users 外键）；2) Exposed schemas 含 app_sigma_fate；3) Secrets 中 URL 与 service_role 属同一项目。",
        ...
        "admin_how_reports_saved": "存档来源：用户登录后在 App 内生成报告，或管理员在此页「现算命盘」后点「保存命盘」。仅排盘预览不会自动写入。",
        "admin_no_saved_report": "该用户尚无存档报告。可点下方「现算命盘」预览，再点「保存命盘」写入存档。",
    ...
    "en": {
        ...
        "tab_ziwei": "🌌 Zi Wei Dou Shu",
        "tab_survey": "📝 Feedback",
        "ziwei_heading": "🌌 Zi Wei Dou Shu",
        "ziwei_intro": "Reuses your BaZi birth data. Si Hua / San He / Flying-star chart views + basic reading are open to all. AI deep read is available to all; Gold/Diamond get a clean view and PDF.",
        "ziwei_theory_title": "📖 Zi Wei basics",
        "ziwei_need_chart": "Generate a chart on Input first so this page can reuse the same birth data (solar time + year/hour pillars).",
        "ziwei_run": "Cast chart & basic reading",
        "ziwei_chart_heading": "Zi Wei chart",
        "ziwei_local_heading": "Basic reading",
        "ziwei_mode_label": "Chart view",
        "ziwei_mode_sihua": "Si Hua",
        "ziwei_mode_sanhe": "San He",
        "ziwei_mode_feixing": "Flying Stars",
        "ziwei_mode_hint": "Order: San He → Si Hua → Flying. San He = Life trine/opposite; Si Hua = year mutagens; Flying = palace-stem fly paths (e.g. Lu→Wealth). Bottom-left age/year = that palace’s decade. See theory expander.",
        "ziwei_basic_hint": "Order: San He → Si Hua → Flying → Decades, then Career/Wealth/Love/Health (rules, not AI).",
        "ziwei_ai_btn": "Generate AI deep read",
        "ziwei_ai_btn_reuse": "Open saved AI deep read",
        "ziwei_ai_btn_regen": "Regenerate AI deep read",
        "ziwei_ai_reuse_unchanged": "Birth data unchanged — opened your saved Zi Wei AI deep read (no DeepSeek call, no quota used).",
        "ziwei_ai_heading": "AI deep read (Career · Wealth · Love · Health)",
        "ziwei_ai_career": "Career",
        "ziwei_ai_wealth": "Wealth",
        "ziwei_ai_love": "Relationships",
        "ziwei_ai_health": "Health",
        "ziwei_ai_fail": "AI deep read failed: ",
        "ziwei_ai_need_login": "Please sign in before generating the AI deep read.",
        "ziwei_ai_watermark_note": "Watermarked preview. Upgrade to Gold for a clean view and PDF (includes AI chapters).",
        "ziwei_ai_clean_note": "Gold/Diamond: clean AI deep read and PDF download.",
        "ziwei_pdf_caption": "Pro PDF (selectable text): cover/TOC → charts → full basic reading → AI deep read.",
        "ziwei_download_pdf": "Download Zi Wei PDF",
        "ziwei_reuse_caption": "Birth source: current BaZi chart data",
        ...
        "name_input_hint": "Defaults to the name from BaZi input; results below update as you edit.",
        "name_enter_hint": "Enter a Chinese name (surname + given name). The full reading appears automatically below.",
        "name_compound": "Compound surname (2-character)",
        "name_analyze": "Generate name report",
        "name_summary": "Summary",
        "name_full": "Full report",
        "name_free_banner": "Open to all: full name reading, no watermark.",
        "name_upgrade_hint": "Name analysis is open to all members.",
        "name_stroke_note": "Strokes use Kangxi / nameology traditional counts; simplified is for input only.",
        "name_kangxi_convert": "Stroke conversion: 「{src}」 → Kangxi/traditional 「{trad}」",
        "name_variant_note": "Variant note: {detail}",
        "name_theory_title": "📖 Name Theory",
        ...
        "ai_deep_btn_reuse": "✨ Open saved AI deep report",
        "ai_deep_btn_free": "✨ AI deep preview (uses free quota)",
        "ai_deep_reuse_unchanged": "Birth data unchanged — opened your saved AI deep report (no DeepSeek call, no quota used).",
        ...
        "admin_sql_hint": "Run SQL 001–010 (incl. 010 reports→sf_users FK fix), expose schema app_sigma_fate, and use matching Supabase URL/key.",
        ...
        "admin_how_reports_saved": "Archives come from a signed-in user generating a report in the app, or from admin Recompute + Save chart here. Preview-only charts are not auto-saved.",
        "admin_no_saved_report": "No saved report yet. Recompute chart below, then click Save chart to archive it.",
