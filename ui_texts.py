...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "survey_gold_hint": "首次提交反馈，即可自动升级为黄金会员（含报告次数与流年篇章）。",
    ...
    "en": {
        ...
        "survey_gold_hint": "Submit feedback for the first time to unlock Gold membership automatically (report quota + Annual Luck).",
