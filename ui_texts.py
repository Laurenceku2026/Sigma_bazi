...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "hehun_intro": "默认本地规则打分（金卡/钻石无水印；免费与银卡各 3 次水印预览）。AI 深批仅钻石会员。",
        "hehun_person_a": "甲方",
        "hehun_person_b": "乙方",
    ...
    "en": {
        ...
        "hehun_intro": "Default local rule score (Gold/Diamond clean; Free & Silver get 3 watermarked previews). AI deep read is Diamond-only.",
