...
TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "en": {
        ...
        "input_auto_report_hint": "One tap: chart + local BaZi report + Annual Luck (no AI tokens). Scroll chart → report → year luck; top tabs jump to each section. AI deep read is a separate button.",
        "results_scroll_hint": "Scroll down: chart, then BaZi report, then Annual Luck. Or tap the top tabs to jump instantly.",
