...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "admin_user_results_hint": "选择用户后可查看其八字命盘、完整报告与流年报告（只读）。",
    ...
    "en": {
        ...
        "admin_user_results_hint": "After selecting a user, browse their BaZi chart, full report, and Annual Luck (read-only).",
