...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tab_name": "✍️ 姓名参考",
        "tab_survey": "📝 试用反馈",
        "name_heading": "✍️ 姓名参考报告",
        "name_intro": "独立本地报告：康熙/繁体笔画五格 + 用字五行提示 + 与八字喜用对照。简繁输入皆可（内部转繁计画）。补的是喜用，不是简单缺啥补啥。",
    ...
    "en": {
        ...
        "tab_name": "✍️ Name Reference",
        "tab_survey": "📝 Feedback",
        "name_heading": "✍️ Name Reference Report",
        "name_intro": "Standalone local report: Kangxi/traditional stroke Five-Grid + character element hints + BaZi favorable-element check. Simplified or traditional input both work (converted for strokes). Reinforce 喜用, not merely missing elements.",
        ...
        "name_analyze": "Generate name reference",
