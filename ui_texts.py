...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "survey_intro": "试用排盘与报告后请打分 1–10（10 最高）。**首次提交问卷可免费升级金卡一次**（10 次报告 + 流年）。",
        ...
        "survey_gold_reward": "🎉 感谢反馈！已为您开通 **金卡会员**（10 次完整报告 + 流年），仅此一次。",
    ...
    "en": {
        ...
        "survey_intro": "Rate 1–10 after trying the chart and report. **First survey submission unlocks Gold once** (10 reports + Annual Luck).",
        ...
        "survey_gold_reward": "🎉 Thanks! You now have **Gold** membership (10 full reports + Annual Luck), one-time only.",
