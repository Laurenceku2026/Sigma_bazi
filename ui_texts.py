...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "admin_recompute_ok": "已按出生资料现算命盘（仅预览，未写入数据库）。",
        "admin_recompute_fail": "现算失败：请检查出生日期/时间是否完整。",
        "admin_recompute_need_birth": "缺少出生日期，无法现算。",
        "admin_bazi_using_recomputed": "当前显示：现算命盘（覆盖存档命盘预览）。",
        "admin_bazi_recomputed": "无存档命盘，已按出生资料现算预览（未写入数据库）。",
    ...
    "en": {
        ...
        "admin_recompute_ok": "Chart recomputed from birth profile (preview only, not saved).",
        ...
        "admin_bazi_using_recomputed": "Showing recomputed chart (overrides archived chart preview).",
        "admin_bazi_recomputed": "No saved chart — recomputed from birth profile for preview (not written to DB).",
