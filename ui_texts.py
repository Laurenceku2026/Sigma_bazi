...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "forgot_password_hint": "填写注册邮箱并确认后，系统会清除旧密码。请立即用同一邮箱重新「注册」设置新密码；会员与历史资料会保留。",
        ...
        "forgot_password_ok": "旧密码已清除。请用同一邮箱重新注册并设置新密码（会员与资料保留）。",
    ...
    "en": {
        ...
        "forgot_password_hint": "Enter your registered email and confirm. We’ll clear the old password so you can Register again with the same email to set a new one. Membership and history are kept.",
        ...
        "forgot_password_ok": "Old password cleared. Please Register with the same email to set a new password (membership kept).",
