...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "goto_liunian_report_bottom": "📅 前往流年报告 ↑",
        "goto_full_report": "📄 返回九页命理报告",
        "goto_full_report_bottom": "📄 前往完整报告 ↑",
    ...
    "en": {
        ...
        "goto_liunian_report_bottom": "📅 Go to Annual Luck Report ↑",
        "goto_full_report": "📄 Back to 9-page report",
        "goto_full_report_bottom": "📄 Go to Full Report ↑",
