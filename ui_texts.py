...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "logout_btn": "退出登录",
        "login_heading": "🔐 邮箱登录",
        "login_caption": "输入注册时使用的邮箱即可登录（无需密码），将自动恢复您的资料与报告",
        "login_submit": "登录并恢复资料",
        "login_ok": "登录成功！已恢复您的资料与历史记录",
        "login_not_found": "未找到该邮箱账号，请先排盘注册，或检查邮箱拼写",
        "login_prompt": "已有账号？请先登录，无需重新填写出生信息",
    ...
    "en": {
        ...
        "login_btn": "🔐 Sign in",
        "logout_btn": "Sign out",
        "login_heading": "🔐 Sign in with email",
        "login_caption": "Use the email you registered with (no password). Your chart and reports will be restored.",
        "login_submit": "Sign in & restore",
        "login_ok": "Signed in! Your profile and history were restored",
        "login_not_found": "No account for this email. Register via charting, or check spelling",
        "login_prompt": "Returning user? Sign in first — no need to re-enter birth info",
