...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "admin_no_saved_report": "该用户尚无存档报告；若有出生资料，可尝试现算命盘。",
    ...
    "en": {
        ...
        "admin_no_saved_report": "No saved reports. Chart may still be recomputed from birth profile.",
        ...
        "admin_no_report": "No saved BaZi report.",
