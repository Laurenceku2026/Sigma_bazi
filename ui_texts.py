...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "admin_user_results_howto": "请先在下方下拉框选择用户，再切换「八字命盘 / 八字报告 / 流年报告」查看（只读）。",
    ...
    "en": {
        ...
        "admin_user_results_howto": "Select a user below, then switch Chart / Report / Annual Luck (read-only).",
