...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tab_survey": "📝 试用反馈",
        "name_heading": "✍️ 姓名详批",
        "name_intro": "姓名报告：康熙/繁体笔画五格 + 用字五行提示 + 与八字喜用对照。简繁输入皆可（内部转繁计画）。补的是喜用，不是简单缺啥补啥。",
        "name_need_chart": "建议先在「输入信息」完成排盘，以便对照八字喜用；也可先看五格摘要。",
        "name_input": "姓名",
        "name_input_ph": "如：张伟 / 張偉 / 欧阳修",
        "name_input_hint": "默认沿用八字输入的姓名，可在此修改后再生成。",
        "name_compound": "复姓（两字姓）",
        "name_analyze": "生成姓名报告",
        "name_summary": "摘要",
        "name_full": "完整报告",
        "name_free_banner": "免费可看含水印摘要；金卡/钻石解锁完整无水印报告（含用字详解与八字对照）。",
        "name_upgrade_hint": "升级金卡后可查看完整姓名报告（无水印）。",
    ...
    "en": {
        ...
        "name_intro": "Name report: Kangxi/traditional Five-Grid + character element hints + BaZi favorable-element check. Simplified or traditional input both work (converted for strokes). Reinforce 喜用, not merely missing elements.",
        "name_need_chart": "Generate a chart on Input first for BaZi comparison; Five-Grid summary still works alone.",
        "name_input": "Name",
        "name_input_ph": "e.g. 张伟 / 張偉 / 欧阳修",
        "name_input_hint": "Defaults to the name from BaZi input; you can edit it here before generating.",
        "name_compound": "Compound surname (2-character)",
        "name_analyze": "Generate name report",
        "name_summary": "Summary",
        "name_full": "Full report",
        "name_free_banner": "Free: watermarked summary. Gold/Diamond: full clean report with character notes and BaZi link.",
        "name_upgrade_hint": "Upgrade to Gold for the full clean name report.",
