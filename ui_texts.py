...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "survey_intro": "试用排盘与报告后请打分 1–10（10 最高）。您的反馈将用于优化八字准确度与使用体验。",
    ...
    "en": {
        ...
        "survey_intro": "Rate 1–10 after trying the chart and report. Your feedback improves accuracy and UX.",
