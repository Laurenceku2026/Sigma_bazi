...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "ziwei_mode_hint": "切换四化 / 三合 / 飞星查看同一命盘的不同标注；下方基础解读综合三套视角。",
        "ziwei_basic_hint": "按四化、三合、飞星三套排盘给出的专业规则摘要（非 AI）。",
        "ziwei_ai_btn": "生成 AI 深批",
        "ziwei_ai_heading": "AI 深批",
        "ziwei_ai_pattern": "命格总论",
        "ziwei_ai_career": "事业财运",
        "ziwei_ai_life": "感情身心",
        ...
        "ziwei_pdf_caption": "PDF 含命盘摘要、基础解读；若已生成 AI 深批将一并收录。",
    ...
    "en": {
        ...
        "ziwei_mode_hint": "Switch Si Hua / San He / Flying Stars on the same chart; the basic reading below combines all three.",
        ...
        "ziwei_ai_pattern": "Natal Pattern",
        "ziwei_ai_career": "Career & Wealth",
        "ziwei_ai_life": "Love, Health & Mind",
        ...
        "ziwei_pdf_caption": "PDF includes chart summary and basic reading; AI chapters are included when generated.",
