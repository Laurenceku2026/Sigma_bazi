...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "generate": "🔮 开始排盘与生成报告",
        "input_auto_report_hint": "点一次即可：排盘 + 生成本地八字报告与流年（不耗 AI）。页面会连续展示命盘→报告→流年；顶部 Tab 可跳到对应位置。AI 深批请另点按钮。",
        "results_scroll_hint": "请向下滚动：命盘之后是八字报告，再往后是流年报告。也可点顶部「八字命盘 / 八字报告 / 流年报告」立刻跳转。",
