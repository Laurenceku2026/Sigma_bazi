...
TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "ziwei_pdf_caption": "专业 PDF：封面目录 + 三合/四化/飞星盘图与解读 + 大限 + 事业/财运/感情/健康（规则与 AI 整合）。",
    ...
    "en": {
        ...
        "ziwei_pdf_caption": "Pro PDF: cover/TOC + San He/Si Hua/Flying charts + decades + Career/Wealth/Love/Health (rules + AI).",
