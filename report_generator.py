...
"""
            ...
            prompt = f"""请写紫微斗数 AI 深批三章（须综合四化、三合、飞星三套视角）：
1) pattern「命格总论」：三合看命宫三方四正骨架，四化看生年禄权科忌，飞星看命宫飞出与自化；
2) career「事业财运」：官禄/财帛/迁移宫，结合三方与飞化牵动给求职求财建议；
3) life「感情身心」：夫妻/疾厄/福德宫，关系经营与身心保养。
要求：理性参考、勿宿命断言；强调「三合看格局、四化看先天、飞星看连动、大限流年看应期」。
命盘：
{chart_txt}
基础解读摘要：
{local_txt}
